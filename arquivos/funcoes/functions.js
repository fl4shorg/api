...
const banner2 = cfonts.render((`AKAME SUPREMACY 9.0.0 OFICIAL`), {
font: 'console',
align: 'center',
gradient: ['red', 'magenta']
});
 
const banner3 = cfonts.render((`AKAME|BOTV9.0`), {
  font: 'block',
  align: "center",
  gradient: ['red', 'magenta']
});
...
const authorname = "Akame Multi-Device"
const packname = "Criador: @YuriModz"

const chyt = "556593065507@s.whatsapp.net";
const nit = "556596947474@s.whatsapp.net";
const supre = "556596947474@s.whatsapp.net";
