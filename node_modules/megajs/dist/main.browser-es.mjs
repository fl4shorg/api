  ...
  async defaultFetch(url, opts) {
    ...
    if (!_API.fetchModule) {
      if (typeof globalThis.fetch === "function") {
        _API.fetchModule = globalThis.fetch;
      } else {
        const nodeFetch = await Promise.resolve().then(() => (init_fetch(), fetch_exports));
        _API.fetchModule = nodeFetch.fetch;
      }
    }
